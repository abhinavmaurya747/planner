...
class Schedulder:
    ...
    def get_planner_prompt(self):
        ...
        assistant_message = f"""I will provide you a desired meal plan."""
        hidden_requests = """\
        ...
        """
        # Step 5> Write "leftover" only where required for "{self.leftover_days}". Write "takeout" only where required for "{self.takeout_days}".
